...
haar_upper_body_cascade = cv2.CascadeClassifier("haarFiles/haarcascade_lowerbody.xml")
...
while True:
    ...
    for (x, y, w, h) in upper_body:
        ...
        cv2.putText(frame, "Lower Body Detected", (x + 5, y + 15), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0, 255, 0), 2) # creates green color text with text size of 0.5 & thickness size of 2
